...
const AUDIO_FILE_NAME = 'Despacito.mp3'


export default class SongsESDespacito extends SongScene {
  static KEY = KEY
  constructor() {
    super(KEY, LYRICS, 'Spanish');
  }

  preload() {
    super.preload();

    this.load.audio(AUDIO_FILE_NAME, [
      'assets/sounds/music/es/' + AUDIO_FILE_NAME
    ]);
  }

  create() {
    this.music = this.sound.add(AUDIO_FILE_NAME);
    super.create();
  }
